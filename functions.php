...
function gt_ambition_setup() {
	...
	add_image_size( 'gt-ambition-header-image', 1920, 640, true );
...
function gt_ambition_scripts() {
	...
	if ( has_nav_menu( 'primary' ) ) {
		wp_enqueue_script( 'gt-ambition-navigation', get_theme_file_uri( '/assets/js/navigation.js' ), array( 'jquery' ), '1.0', true );
