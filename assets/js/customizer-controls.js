...
( function( wp, $ ) {
	 ...
	 */
	wp.customize.controlConstructor.gt_ambition_custom_font = wp.customize.Control.extend({
		/**
	 ...
	 * where type == the type member of a WP_Customize_Control
	 */
	wp.customize.controlConstructor.gt_ambition_license_key = wp.customize.Control.extend({
		/**
		 * This method is called when the control is ready to run.
		 */
		ready: function() {
