...
* Custom Fonts Class
*/
class GT_Ambition_Custom_Fonts {
	...
	static function setup() {
		...
		add_filter( 'gt_ambition_get_fonts_url', array( __CLASS__, 'get_custom_fonts_url' ) );
	}
	...
	static function add_custom_fonts_in_frontend() {
		wp_add_inline_style( 'gt-ambition-stylesheet', self::get_custom_fonts_css() );
	}
	...
	static function add_custom_fonts_in_editor() {
		wp_add_inline_style( 'gt-ambition-editor-styles', self::get_custom_fonts_css() );
	}
	...
	static function get_custom_fonts_css() {
		...
		$default_options = gt_ambition_default_options();
...
// Run Class.
GT_Ambition_Custom_Fonts::setup();
