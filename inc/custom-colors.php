 ...
 * Custom Colors Class
 */
class GT_Ambition_Custom_Colors {
	...
	static function add_custom_colors_in_frontend() {
		wp_add_inline_style( 'gt-ambition-stylesheet', self::get_custom_colors_css() );
	}
	...
	static function add_custom_colors_in_editor() {
		wp_add_inline_style( 'gt-ambition-editor-styles', self::get_custom_colors_css() );
	}
...
// Run Class.
GT_Ambition_Custom_Colors::setup();
