 ...
 *
 * Prevents GT Ambition from running on WordPress versions prior to 4.7,
 ...
 * GT Ambition on WordPress versions prior to 4.7.
 *
 * @global string $wp_version WordPress version.
 */
function gt_ambition_upgrade_notice() {
	$message = sprintf( esc_html__( '%1$s requires at least WordPress version %2$s. You are running version %3$s. Please upgrade and try again.', 'gt-ambition' ), 'GT Ambition', '4.7', $GLOBALS['wp_version'] );
...
function gt_ambition_customize() {
	wp_die( sprintf( esc_html__( '%1$s requires at least WordPress version %2$s. You are running version %3$s. Please upgrade and try again.', 'gt-ambition' ), 'GT Ambition', '4.7', $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function gt_ambition_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( esc_html__( '%1$s requires at least WordPress version %2$s. You are running version %3$s. Please upgrade and try again.', 'gt-ambition' ), 'GT Ambition', '4.7', $GLOBALS['wp_version'] ) );
	}
}
